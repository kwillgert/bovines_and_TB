#edit of ggcorr function to avoid cutting labels on y-axis
ggcorr_edit<-function (data, method = c("pairwise", "pearson"), cor_matrix = NULL, 
                       ...
                       ...) 
{
  ...
  p = p + geom_text(data = textData, aes_string(label = "diagLabel"), 
    ...
    scale_y_discrete(breaks = NULL, limits = levels(m$y), expand = expansion(mult = c(0.01, 0.12))) + #expansion added
